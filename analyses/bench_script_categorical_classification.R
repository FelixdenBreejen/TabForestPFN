...
plot_aggregated_results(df, y_inf=0.4, y_sup=0.95, score="accuracy", quantile=0.1, truncate_scores = F, text_size=8, theme_size=25, max_iter=400)
...
plot_aggregated_results(df, y_inf=0.4, y_sup=0.95, score="accuracy", max_iter=400)
