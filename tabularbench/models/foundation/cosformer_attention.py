...
class CosformerAttention(nn.Module):
    ...
    def forward(
        ...
        key = einops.rearrange(key, 'b n d -> n b d')
        value = einops.rearrange(value, 'b n d -> n b d')
        ...
        mask = key_padding_mask.repeat_interleave(num_heads, dim=0)
        ...
        if self.causal:
            ...
            k_ = k_.masked_fill(mask.unsqueeze(-1), 0)
