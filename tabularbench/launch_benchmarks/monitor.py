...
if __name__ == "__main__":
    ...
    parser.add_argument('--filename', type=str, default="launch_benchmarks/sweeps/all_benchmark_medium.csv")
    # Maximum number of runs per dataset
    parser.add_argument('--max_runs', type=int, default=1000)
    # Name of the file to save the results
    parser.add_argument('--output_filename', type=str, default="launch_benchmarks/results/results.csv")
